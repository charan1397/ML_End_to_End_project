#Main Purpouse of Using this Feature engineering/Data Cleaning 
#And Convert data set categorical feature into Numerical features
import sys
...
class DataTransformation:
    ...
    def initiate_data_trasformation(self,train_path,test_path):
        ...
        try:        
            ...
            logging.info("Read train and tset data completed")
            ...
            logging.info(f"Saved preprocesiing object.")
